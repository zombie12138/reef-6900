...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(81))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_2_kernel1_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    // Force the compiler to use all the index
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(31))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_1_kernel2_device_wrapper(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 196 + blockIdx.z * 1 * 196 >= 196 * 1 * 1) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(63))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_kernel1_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    // Force the compiler to use all the index
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(81))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_1_kernel1_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 98 + threadIdx.z * 8 * 98 >= 98 * 8 * 1) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 4 * 1 >= 1 * 4 * 16) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(45))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 64 + blockIdx.z * 1 * 64 >= 64 * 1 * 1) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(81))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_2_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(127))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_1_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute) {
    // Force the compiler to use all the index
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(63))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_3_kernel2_device_wrapper(float* __restrict__ bgemm, float* __restrict__ T_add, float* __restrict__ placeholder) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 98 + blockIdx.z * 1 * 98 >= 98 * 1 * 1) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(45))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_multiply_add_nn_re_11882905421691233276__kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 64 + blockIdx.z * 1 * 64 >= 64 * 1 * 1) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(31))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_2_kernel2_device_wrapper(float* __restrict__ bgemm, float* __restrict__ T_add, float* __restrict__ placeholder) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 196 + blockIdx.z * 1 * 196 >= 196 * 1 * 1) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(81))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_3_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 98 + blockIdx.z * 1 * 98 >= 98 * 1 * 1) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(45))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_1_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 196 + blockIdx.z * 1 * 196 >= 196 * 1 * 1) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(45))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 64 + blockIdx.z * 1 * 64 >= 64 * 1 * 1) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(63))) __attribute__((amdgpu_num_sgpr(34))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_kernel1_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 49 + threadIdx.z * 4 * 49 >= 49 * 4 * 1) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 16 * 1 >= 1 * 16 * 16) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(63))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_2_kernel2_device_wrapper(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 98 + blockIdx.z * 1 * 98 >= 98 * 1 * 1) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(45))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_1_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 98 + blockIdx.z * 1 * 98 >= 98 * 1 * 1) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(31))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_kernel2_device_wrapper(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 98 + blockIdx.z * 1 * 98 >= 98 * 1 * 1) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(63))) __attribute__((amdgpu_num_sgpr(49))) void fused_nn_conv2d_add_nn_relu_1_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(81))) __attribute__((amdgpu_num_sgpr(66))) void fused_nn_conv2d_add_nn_relu_2_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(45))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_multiply_add_nn_re_11882905421691233276__kernel2_device_wrapper(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 64 + blockIdx.z * 1 * 64 >= 64 * 1 * 1) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(125))) __attribute__((amdgpu_num_sgpr(50))) void fused_nn_conv2d_add_nn_relu_3_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(29))) __attribute__((amdgpu_num_sgpr(34))) void fused_nn_conv2d_2_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 14 + threadIdx.z * 1 * 14 >= 14 * 1 * 32) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(63))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_multiply_add_nn_re_11882905421691233276__kernel1_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 8 + threadIdx.z * 32 * 8 >= 8 * 32 * 1) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 8 * 1 >= 1 * 8 * 16) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(45))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 98 + blockIdx.z * 1 * 98 >= 98 * 1 * 1) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(37))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_add_nn_relu_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(31))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_1_kernel2_device_wrapper(float* __restrict__ bgemm, float* __restrict__ T_add, float* __restrict__ placeholder) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 98 + blockIdx.z * 1 * 98 >= 98 * 1 * 1) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(63))) __attribute__((amdgpu_num_sgpr(34))) void fused_nn_conv2d_3_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute) {
    // Force the compiler to use all the index
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(63))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_2_kernel1_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 14 + threadIdx.z * 32 * 14 >= 14 * 32 * 1) return;
    // if (blockIdx.x + blockIdx.y * 7 + blockIdx.z * 1 * 7 >= 7 * 1 * 36) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(45))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_kernel2_device_wrapper(float* __restrict__ bgemm, float* __restrict__ T_add, float* __restrict__ placeholder) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 64 + blockIdx.z * 1 * 64 >= 64 * 1 * 1) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(63))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_3_kernel1_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 14 + threadIdx.z * 32 * 14 >= 14 * 32 * 1) return;
    // if (blockIdx.x + blockIdx.y * 7 + blockIdx.z * 1 * 7 >= 7 * 1 * 36) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(63))) __attribute__((amdgpu_num_sgpr(34))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_1_kernel1_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 49 + threadIdx.z * 4 * 49 >= 49 * 4 * 1) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 16 * 1 >= 1 * 16 * 16) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(45))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_2_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 196 + blockIdx.z * 1 * 196 >= 196 * 1 * 1) return;
