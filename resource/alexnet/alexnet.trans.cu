...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(63))) __attribute__((amdgpu_num_sgpr(89))) void fused_nn_conv2d_nn_relu_3_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu) {
    // Force the compiler to use all the index
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(45))) __attribute__((amdgpu_num_sgpr(34))) void fused_nn_conv2d_nn_relu_1_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu) {
    // Force the compiler to use all the index
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(39))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_dense_add_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 64 + threadIdx.z * 1 * 64 >= 64 * 1 * 1) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(47))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_dense_add_nn_relu_1_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 64 + threadIdx.z * 1 * 64 >= 64 * 1 * 1) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(47))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_nn_relu_4_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu) {
    // Force the compiler to use all the index
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(45))) __attribute__((amdgpu_num_sgpr(34))) void fused_nn_conv2d_nn_relu_2_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 4 + threadIdx.z * 2 * 4 >= 4 * 2 * 32) return;
    // if (blockIdx.x + blockIdx.y * 3 + blockIdx.z * 6 * 3 >= 3 * 6 * 12) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(45))) __attribute__((amdgpu_num_sgpr(34))) void fused_nn_conv2d_nn_relu_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 4 + threadIdx.z * 2 * 4 >= 4 * 2 * 32) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(39))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_dense_add_nn_relu_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 64 + threadIdx.z * 1 * 64 >= 64 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 4096 + blockIdx.z * 1 * 4096 >= 4096 * 1 * 1) return;
